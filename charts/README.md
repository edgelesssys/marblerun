...
| `coordinator.version`                        | string         | Version of the coordinator container image to pull | `"v1.3.0"` |
...
| `marbleInjector.version`                     | string         | Version of the marbleInjector container image to pull | `"v1.3.0"` |
