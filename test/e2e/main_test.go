...
var (
	...
	marbleImageName              = flag.String("marble-image-name", "ghcr.io/edgelesssys/marblerun-enterprise-e2e/test-marble", "name of the marble container image to use in tests")
