...
const (
	PathType_File PathType = 0
	PathType_Env  PathType = 1
)
...
func (x *ActivationResp) GetCertificate() []byte {
	if x != nil {
...
type Parameters struct {
	...
	Secrets map[string]*SecretList `protobuf:"bytes,3,rep,name=Secrets,proto3" json:"Secrets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *Parameters) GetSecrets() map[string]*SecretList {
	if x != nil {
		return x.Secrets
	}
	return nil
...
type Secret struct {
	...
	Type PathType `protobuf:"varint,1,opt,name=type,proto3,enum=rpc.PathType" json:"type,omitempty"`
...
func (x *Secret) GetType() PathType {
	if x != nil {
		return x.Type
	}
...
var file_coordinator_proto_rawDesc = []byte{
	...
	,
	...
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x03, 0x45, 0x6e, 0x76, 0x12, 0x36, 0x0a, 0x07, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x72, 0x70,
	0x63, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x53, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x53, 0x65, 0x63, 0x72, 0x65,
	0x74, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x41, 0x72, 0x67, 0x76, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x04, 0x41, 0x72, 0x67, 0x76, 0x1a, 0x38, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x45,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4b, 0x0a, 0x0c, 0x53, 0x65, 0x63, 0x72,
	...
	,
...
var file_coordinator_proto_goTypes = []interface{}{
	(PathType)(0),          // 0: rpc.PathType
	(*ActivationReq)(nil),  // 1: rpc.ActivationReq
	(*ActivationResp)(nil), // 2: rpc.ActivationResp
	(*Parameters)(nil),     // 3: rpc.Parameters
	(*Secret)(nil),         // 4: rpc.Secret
	(*SecretList)(nil),     // 5: rpc.SecretList
	nil,                    // 6: rpc.Parameters.FilesEntry
	nil,                    // 7: rpc.Parameters.EnvEntry
	nil,                    // 8: rpc.Parameters.SecretsEntry
}
var file_coordinator_proto_depIdxs = []int32{
	3, // 0: rpc.ActivationResp.Parameters:type_name -> rpc.Parameters
	6, // 1: rpc.Parameters.Files:type_name -> rpc.Parameters.FilesEntry
	7, // 2: rpc.Parameters.Env:type_name -> rpc.Parameters.EnvEntry
	8, // 3: rpc.Parameters.Secrets:type_name -> rpc.Parameters.SecretsEntry
	0, // 4: rpc.Secret.type:type_name -> rpc.PathType
	4, // 5: rpc.SecretList.Secrets:type_name -> rpc.Secret
	5, // 6: rpc.Parameters.SecretsEntry.value:type_name -> rpc.SecretList
	1, // 7: rpc.Marble.Activate:input_type -> rpc.ActivationReq
	2, // 8: rpc.Marble.Activate:output_type -> rpc.ActivationResp
